...
class UI:
    ...
    def circulo():
        ...
        x = Circulo()
        x.set_raio(float(input("Informe o valor da raio: ")))
        area = x.calc_area()
        circunferencia = x.calc_circunferencia()
        print(f"Um Circulo com raio {x.get_raio()} tem área de {area} e circunferencia de {circunferencia}")

    @staticmethod
    def viagem():
        print("Cálculo da Velocidade Media")
        x = Viagem()
        x.set_distancia(float(input("Informe o valor da distancia: "))) 
        x.set_tempo(float(input("Informe o valor do tempo: ")))
        vel_med = x.velocidade_media()
        print(f"Uma viagem com distancia {x.get_distancia()}em kms e tempo de {x.get_tempo()} em horas tem a Velocidade Media de {vel_med} km/h")
    ...
    def conta_bancaria():
        ...
        x.set_num_conta(float(input("Informe o Número da Conta: ")))
    ...
    def ingresso():
        print("Ingressos")
        x = Ingresso()
        x.set_dia((input("Informe o dia: ")))     
        x.set_horario(float(input("Informe o horario: ")))     
        idade = float(input("Digite a sua Idade: "))
        calculo_ingresso = x.calc_ingresso(idade)
        print(f"Seu Ingresso que é do dia {x.get_dia()} que tem horario de {x.get_horario()} horas. O valor que será pago é de {calculo_ingresso} reais")   
